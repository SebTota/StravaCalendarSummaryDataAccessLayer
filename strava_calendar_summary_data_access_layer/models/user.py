...
class User:
    ...
    def from_dict(source):
        ...
        calendar_auth = oauth2client.from_dict(source['calendar_auth']) if 'calendar_auth' in source else None
    ...
    def to_dict(self):
        ...
        d['calendar_auth'] = self.calendar_auth.to_dict() if self.calendar_auth is not None else None
        return d
