...
DEFAULT_EVENT_TEMPLATE = 'Name: {name}\n' \
                         'Distance: {distance_miles}\n' \
                         'Duration: {duration}\n' \
                         'Pace: {pace_min_per_mile}'
DEFAULT_SUMMARY_TITLE_TEMPLATE = 'Total Distance: {distance_miles}'
DEFAULT_SUMMARY_TEMPLATE = 'Total Distance: {distance_miles}\n' \
...
class CalendarPreferences:
    def __init__(self, per_run_summary_enabled: bool = True, per_run_title_template: str = DEFAULT_TITLE_TEMPLATE,
                 per_run_summary_template: str = DEFAULT_EVENT_TEMPLATE,
                 daily_run_summary_enabled: bool = True, daily_run_title_template: str = DEFAULT_SUMMARY_TITLE_TEMPLATE,
                 daily_run_summary_template: str = DEFAULT_SUMMARY_TEMPLATE,
                 weekly_run_summary_enabled: bool = True,
                 weekly_run_title_template: str = DEFAULT_SUMMARY_TITLE_TEMPLATE,
                 weekly_run_summary_template: str = DEFAULT_SUMMARY_TEMPLATE,
